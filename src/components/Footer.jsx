  ...
  <a href="mailto:mkmthangamaligai@gmail.com" aria-label="Gmail">
    <FaEnvelope size={30} />
      ...
      <div className="footer-bottom">
        <p>
          © {currentYear} MKM Thangamaligai LLP. All rights reserved. The product/service names listed in this document are marks and/or registered marks of their respective owners and used under license. Unauthorized use strictly prohibited.
        </p>
      </div>
    </footer>
  );
